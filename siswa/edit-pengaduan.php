...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['foto']) && $_FILES['foto']['error'] == 0) {
        ...
        if (in_array($file_extension, $allowed_extensions)) {
            if (!empty($pengaduan['foto']) && file_exists($target_dir . $pengaduan['foto'])) {
                unlink($target_dir . $pengaduan['foto']);
            }
    ...
    $query_update = "UPDATE pengaduan SET 
...
<head>
    ...
    <title>Edit Pengaduan - SAPSI</title>
    <style>
        body {
...
<body>
    ...
    <div class="main-content">
        <div class="top-bar">
            ...
            <small>Ubah informasi pengaduan Anda</small>
        </div>
        ...
        <div class="alert alert-info">
            <strong>Catatan:</strong> Anda hanya dapat mengedit pengaduan yang berstatus Pending
        </div>
                ...
                <div class="row">
                        ...
                        <select name="id_kategori" class="form-select" required>
                            ...
                            <?php while ($kategori = mysqli_fetch_assoc($result_kategori)): ?>
                                <option value="<?= $kategori['id_kategori'] ?>" 
                                        <?= $pengaduan['id_kategori'] == $kategori['id_kategori'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="judul_pengaduan" class="form-control" 
                               value="<?= $pengaduan['judul_pengaduan'] ?>" required>
                    </div>
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <?php if (!empty($pengaduan['foto'])): ?>
                            <div class="mb-2">
                                ...
                                <img src="../uploads/<?= $pengaduan['foto'] ?>" class="current-image">
                            </div>
                        <?php endif; ?>
                        ...
                        <small class="text-muted">
                            ...
                            <?= !empty($pengaduan['foto']) ? 'Upload foto baru untuk mengganti.' : '' ?>
                        </small>
                        <div id="preview"></div>
                    </div>
        ...
        function previewImage(event) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    preview.innerHTML = '<small>Preview Foto Baru:</small><br><img src="' + e.target.result + '" class="preview-image">';
                }
